...
public class TestEnvironment
{
	...
	public async Task SetUpAsync()
	{
		...
		// Keep the retention scheduler out of integration tests so it can't
		// race the rows the tests are about to insert.
		Environment.SetEnvironmentVariable("SchedulerSettings__Schedulers__0__IsEnabled", "false");
	}
